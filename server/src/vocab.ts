...
export const FIELD_VOCAB: FieldDef[] = [
  ...
  { key: "exterior.color.hex", label: "Exterior hex", group: "character", layer: "owner", valueType: "string" },
  { key: "exterior.trim", label: "Trim color", group: "character", layer: "owner", valueType: "string" },
  { key: "exterior.trim.hex", label: "Trim hex", group: "character", layer: "owner", valueType: "string" },
  { key: "exterior.door", label: "Front door", group: "character", layer: "owner", valueType: "string" },
  { key: "exterior.door.hex", label: "Door hex", group: "character", layer: "owner", valueType: "string" },
