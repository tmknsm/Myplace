...
export const TOPICS: Topic[] = [
  {
    ...
    fields: [
      ...
      { key: "exterior.color.hex", label: "Swatch", kind: "hex", hint: "#30474f", half: true },
      { key: "exterior.trim", label: "Trim", hint: "Benjamin Moore Simply White", half: true },
      { key: "exterior.trim.hex", label: "Swatch", kind: "hex", hint: "#f4f2ea", half: true },
      { key: "exterior.door", label: "Front door", hint: "Oxblood, original oak underneath", half: true },
      { key: "exterior.door.hex", label: "Swatch", kind: "hex", hint: "#4a0e0e", half: true },
